...
//import '../../theme/app_colors.dart'; // Uncomment if AppColors is needed elsewhere
...
class DataNewsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RichText(
      ...
      text: TextSpan(
        style: AppTextStyles
            .body, // Use the standard text style definition from app_textstyles
        children: <TextSpan>[
          // Title
          TextSpan(
            text:
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () async {
                ...
                if (await canLaunchUrl(url)) {
                  ...
                  // In this example, we just print to console as alert() is not allowed.
          ...
          TextSpan(
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () async {
                final url = Uri.parse('https://neoskosmos.com/'); // Example URL
                if (await canLaunchUrl(url)) {
                  await launchUrl(url);
                } else {
                  print('Could not launch $url');
          ...
          TextSpan(
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () async {
                final url = Uri.parse('tel:+30210324xxx'); // Phone number
                if (await canLaunchUrl(url)) {
                  await launchUrl(url);
                } else {
                  print('Could not launch $url');
